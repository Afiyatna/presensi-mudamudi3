...
function AttendanceReportDaerah() {
  ...
  // Tambahkan CSS global untuk mode exporting desktop
  ...
  return (
    <LayoutDashboard pageTitle="Rekap Presensi Daerah">
      <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        {loading ? (
          <DataLoadingSpinner message="Memuat data presensi daerah..." />
        ) : (
          <>
            {/* Statistik Kehadiran */}
