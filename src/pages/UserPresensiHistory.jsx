          ...
          {filteredPresensi.length === 0 ? (
            ...
            <>
              ...
              <div className="md:hidden space-y-4">
                {filteredPresensi.map((row, index) => (
                  <div key={row.id + row.jenis_presensi} className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">Tanggal & Waktu</p>
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm mt-2">
                      <div>
                        <p className="text-gray-500 dark:text-gray-400 font-medium">Jenis Presensi</p>
                        <p className="text-gray-900 dark:text-gray-100">{row.jenis_presensi}</p>
                      </div>
                      <div>
                        <p className="text-gray-500 dark:text-gray-400 font-medium">Kelompok</p>
                        <p className="text-gray-900 dark:text-gray-100">{row.kelompok}</p>
                      </div>
                      <div>
                        <p className="text-gray-500 dark:text-gray-400 font-medium">Desa</p>
                        <p className="text-gray-900 dark:text-gray-100">{row.desa}</p>
                      </div>
                      <div>
