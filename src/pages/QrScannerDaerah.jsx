...
const getLastScanTimesDaerah = () => {
  try {
    return JSON.parse(localStorage.getItem('lastScanTimesDaerah') || '{}');
  } catch {
    return {};
  }
};
const setLastScanTimeDaerah = (userId, timestamp) => {
  const data = getLastScanTimesDaerah();
  data[userId] = timestamp;
  localStorage.setItem('lastScanTimesDaerah', JSON.stringify(data));
};

export default function QrScannerDaerah() {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
        <Header sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} pageTitle="QR Scanner Presensi Daerah" />
        <main className="grow">
